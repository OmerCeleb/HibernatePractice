...
public class RunnerSave06 {
    public static void main(String[] args) {
        ...
        //iliski sahibi tarafinda set edilmeli * mapped by olanin diger tarafi
        //company devlere set ettik
        ...
        //com1.getDevs().add(dev1); --> DB de iliski kurulmaz cunku iliski sahibi dev kismi
